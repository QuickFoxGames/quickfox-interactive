            ...
            <div className="mx-auto max-w-7xl px-6 py-16 grid md:grid-cols-2 gap-10 items-center">
                <div>
                    ...
                    <div className="mt-8 flex flex-wrap gap-3">
                        <a href="#contact" className="px-5 py-3 rounded-2xl bg-orange-600 text-white font-semibold hover:bg-orange-700">Book a 20‑minute scoping call</a>
                    </div>
                </div>
...
function Services() {
    const rows = [
        {
            name: 'Discovery (1–2 weeks)',
            scope: 'Product brief, tech plan, estimate, concepts',
            price: '$4k–$12k (one‑time fee)',
            hours: 'N/A'
        },
        {
            name: 'MVP (8–12 weeks)',
            scope: 'Core features; product for internal use/testing',
            price: '$25k–$65k (one‑time fee)',
            hours: '360 hours (est.)'
        },
        {
            name: 'Standard (12–20 weeks)',
            scope: 'Complete initial build; viable public access product',
            price: '$60k–$150k (one‑time fee)',
            hours: '960 hours (est.)'
        },
        {
            name: 'Enterprise (20–36+ weeks)',
            scope: 'Complete initial build; third‑party integrations; real‑time intercommunication; encryption',
            price: '$150k–$400k (one‑time fee)',
            hours: '2400 hours (est.)'
        },
        {
            name: 'Maintenance (20–60 hrs/month)',
            scope: 'Crash fixes; OS updates; general bug fixes',
            price: '$2k–$10k per month',
            hours: 'N/A'
        }
    ];
    return (
...
function Contracts() {
    return (
        <section id="contracts" className="py-16 bg-slate-50">
            <div className="mx-auto max-w-7xl px-6">
    ...
    return (
        <footer className="border-t border-slate-200">
            <div className="mx-auto max-w-7xl px-6 py-10 flex flex-col md:flex-row gap-6 items-center justify-between">
                ...
                <p className="text-sm text-slate-500">© {new Date().getFullYear()} QuickFox Interactive. All rights reserved.</p>
            </div>
        </footer>
    );
}
        ...
        <div className="mx-auto w-full max-w-sm">
            <div className="aspect-[9/19] rounded-[2.2rem] border border-slate-300 shadow-md p-3 bg-white">
                <div className="h-full rounded-[1.8rem] bg-gradient-to-br from-slate-900 to-slate-800 text-white p-5 flex flex-col">
                    ...
                    <div className="mt-6 text-sm text-white/80 leading-relaxed">Cross‑platform mobile apps made with Unity</div>
